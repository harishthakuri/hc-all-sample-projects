...
using CSharp_Oop_DesignPatter.src.DesignPatterns.Structural.Proxy.GoodExample.ThirdPartyVideoLib;

namespace CSharp_Oop_DesignPatter.src.DesignPatterns.Structural.Proxy.GoodExample
{
