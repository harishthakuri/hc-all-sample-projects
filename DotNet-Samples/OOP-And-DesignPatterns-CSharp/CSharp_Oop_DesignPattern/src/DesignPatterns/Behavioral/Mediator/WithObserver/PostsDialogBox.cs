...
using CSharp_Oop_DesignPatter.src.DesignPatterns.Behavioral.Mediator.WithObserver.UIFramework;


namespace CSharp_Oop_DesignPatter.src.DesignPatterns.Behavioral.Mediator.WithObserver
{
