...
using CSharp_Oop_DesignPatter.src.DesignPatterns.Behavioral.Mediator.GoodExample.UIFramework;

namespace CSharp_Oop_DesignPatter.src.DesignPatterns.Behavioral.Mediator.GoodExample
{
