...
using CSharp_Oop_DesignPatter.src.DesignPatterns.Creational.Builder.BadExample.Components;

namespace CSharp_Oop_DesignPatter.src.DesignPatterns.Creational.Builder.BadExample
{
    public class Manual
    {
